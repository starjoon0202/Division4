...
#        logger.info('Service was processed in Central Cloud')
        ...
        if nsh_decode.is_data_message(data):
            ...
            if nsh_decode.is_vxlan_nsh_legacy_message(data):
                ...
                if self.server_base_values.service_path % 4== 1 :
                    print(C_BOLD + C_YELLOW + "iCPS Service Processing ... " + C_END)
                    
                elif self.server_base_values.service_path % 4 == 3  :
                    print("Received Mornitoring Packet ... ")
                    


                if sfc_globals.sff_queued_packets < 10:
                   time.sleep(0.01)
  #                 print ("<5")
                elif sfc_globals.sff_queued_packets >= 10 and sfc_globals.sff_queued_packets < 20:
                   time.sleep(0.011)
   #                print ("<10")
                elif sfc_globals.sff_queued_packets >= 20 and sfc_globals.sff_queued_packets < 30:
                   time.sleep(0.020)
   #                print ("<15")
                elif sfc_globals.sff_queued_packets >= 30 and sfc_globals.sff_queued_packets < 40:
                   time.sleep(0.025)
     #              print ("<20")
                elif sfc_globals.sff_queued_packets >= 40 and sfc_globals.sff_queued_packets < 50:
                   time.sleep(0.012)
      #             print ("<25")
                elif sfc_globals.sff_queued_packets >= 50 and sfc_globals.sff_queued_packets < 60:
                   time.sleep(0.013)
       #            print ("<30")
                elif sfc_globals.sff_queued_packets >= 60 and sfc_globals.sff_queued_packets < 70:
                   time.sleep(0.015)
       #            print ("<35")
                elif sfc_globals.sff_queued_packets >= 70 and sfc_globals.sff_queued_packets < 80:
                   time.sleep(0.015)
       #            print ("<80")
